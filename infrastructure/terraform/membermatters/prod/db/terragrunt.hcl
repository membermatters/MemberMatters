...
inputs = {
  ...
  engine = "mysql"
  # aws rds describe-db-engine-versions --engine mysql | jq '.DBEngineVersions[].EngineVersion'
  engine_version = "8.0.20"
  port = "3306"
  # aws rds describe-db-engine-versions --engine mysql | jq '.DBEngineVersions[].DBParameterGroupFamily'
  family = "mysql8.0"
  # DB option group
  # major_engine_version = "9.6"
  major_engine_version = "8.0"
  rds_master_user = "memberroot"
