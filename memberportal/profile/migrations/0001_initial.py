...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('digital_id_token', models.UUIDField(blank=True, default=uuid.uuid4, null=True, verbose_name='Digital ID Token')),
                ('digital_id_token_expire', models.DateTimeField(blank=True, default=datetime.datetime.now, editable=False, null=True)),
                ...
                ('state', models.CharField(choices=[('noob', 'New'), ('active', 'Active'), ('inactive', 'Inactive')], default='noob', max_length=8)),
                ('picture', models.ImageField(blank=True, null=True, upload_to=profile.models.Profile.path_and_rename)),
                ...
                ('last_induction', models.DateTimeField(blank=True, default=None, null=True)),
                ...
                ('stripe_payment_method_id', models.CharField(blank=True, default='', max_length=100, null=True)),
            ...
            options={
                'permissions': [('change_staff', 'Can change if the user is a staff member or not'), ('manage_access', "Can manage a user's access permissions"), ('deactivate_member', 'Can deactivate or activate a member'), ('see_personal_details', "Can see and update a member's personal details"), ('manage_memberbucks_balance', 'Can see and modify memberbucks balance'), ('member_logs', 'Can see a members log'), ('generate_invoice', 'Can generate a member invoice')],
            },
        ),
        migrations.CreateModel(
            name='UserEventLog',
